...
Color.Picker = function (props) {
	...
	this.clearall = props.clearall || function(){};
	this.fillall = props.fillall || function(){};
	this.pipette = props.pipette || function(){};
	...
	var hexBoxBigDiv = document.createElement("div");
	hexBoxBigDiv.className = "hexBoxBigDiv";
	...
	hexBox.style.width = "26px";
	hexBox.style.height = "26px";
	hexBoxContainer.appendChild(hexBox);
	hexBoxContainer.style.width = "26px";
	hexBoxContainer.style.height = "26px";
	hexBoxContainer.className = "pull-left";
	hexBoxContainer.style.margin = "2px 10px 2px 6px";
	hexBoxBigDiv.appendChild(hexBoxContainer);

	/// Creating the HEX input element.
	var isHex = /[^a-f0-9]/gi;
	var hexInput = document.createElement("input");
	hexInput.title = "HEX Code";
	hexInput.className = "hexInput input-small";
	hexInput.size = 6;
	hexInput.type = "text";
	//
	...
	//input
	var hexInputDiv = document.createElement("div");
	hexInputDiv.className = "hexInputDiv pull-left";
	hexInputDiv.appendChild(hexInput);
	hexBoxBigDiv.appendChild(hexInputDiv);

	//fillall btn
	var hexBtnDiv1 = document.createElement("div");
	hexBtnDiv1.className = "hexBtnDiv pull-left";
	var fillBtn = document.createElement("button");
	fillBtn.className = "btn btn-info";
	fillBtn.innerHTML = "Fill All";
	Event.add(fillBtn, "click", this.fillall);
	hexBtnDiv1.appendChild(fillBtn);

	//clearall btn
	var hexBtnDiv2 = document.createElement("div");
	var clearBtn = document.createElement("button");
	hexBtnDiv2.className = "hexBtnDiv pull-left";
	clearBtn.className = "btn btn-danger";
	clearBtn.innerHTML = "Clear";
	Event.add(clearBtn, "click", this.clearall);
	hexBtnDiv2.appendChild(clearBtn);

	//pipette btn
	var hexBtnDiv3 = document.createElement("div");
	hexBtnDiv3.className = "hexBtnDiv pull-left hexPipeBtn";
	Event.add(hexBtnDiv3, "click", this.pipette);

	hexBoxBigDiv.appendChild(hexBtnDiv1);
	hexBoxBigDiv.appendChild(hexBtnDiv2);
	hexBoxBigDiv.appendChild(hexBtnDiv3);
	...
	plugin.appendChild(canvasDiv);
	plugin.appendChild(hexBoxBigDiv);
